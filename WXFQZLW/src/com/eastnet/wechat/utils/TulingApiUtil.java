...
public class TulingApiUtil {
	...
	private static final String KEY = "aae00b4a82834d3c9ec6175ddd1e86db";
	...
	public static String getTulingResult(String content) {
		...
		try {
			...
			/**
			 * code 说明 100000 文本类 200000 链接类 302000 新闻类 308000 菜谱类
			 */
...
public static void main(String[] args) {
	String respContent=TulingApiUtil.getTulingResult("haha");
